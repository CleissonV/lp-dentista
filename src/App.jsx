        ...
        <div className="max-w-7xl mx-auto px-6 flex items-center justify-between">
          <a href="#" className="flex items-center gap-2">
            <div className="w-8 h-8 bg-gradient-to-br from-[#0077b6] to-[#00b4d8] rounded-full flex items-center justify-center">
              <svg viewBox="0 0 24 24" className="w-4 h-4" fill="white"><path d="M12 3c-3 0-4 1.5-4 4 0 3 1 4 1.5 7 .3 1.8.5 3 1.5 3s1-1.2 1.3-2.6c.15-.7.5-1 .7-1s.55.3.7 1c.3 1.4.3 2.6 1.3 2.6s1.2-1.2 1.5-3c.5-3 1.5-4 1.5-7 0-2.5-1-4-4-4-1 0-1.3.5-2 .5S13 3 12 3Z" /></svg>
            </div>
